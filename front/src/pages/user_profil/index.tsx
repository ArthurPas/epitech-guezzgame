                            ...
                            <div>
                                <div>
                                    <div>
                                            ...
                                            <>
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="flex items-center p-6">
                                                        <img
                                                            className="w-40 h-40"
                                                            src="https://pbs.twimg.com/media/GObopGNWoAA_fj-.jpg"
                                                            alt=""
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        {userData?.nbCoin >= 1000 && userData?.nbCoin < 5000 && <p>La daronne à l'abri</p>}
                                            ...
                                            <>
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="flex items-center p-6">
                                                        <img
                                                            className="w-40 h-40"
                                                            src="https://a.pinatafarm.com/766x554/4a6141c288/vile-evil-goblin_1.jpeg"
                                                            alt=""
                                                        />
                                                    </div>
                                                </div>
